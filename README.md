...
O FFmpeg é necessário para o funcionamento correto do programa.
...
Sem ele, alguns downloads podem falhar ou sair sem áudio.
...
Extraia o arquivo `.7z` usando o 7-Zip.

---

### 4. Localizar o executável
